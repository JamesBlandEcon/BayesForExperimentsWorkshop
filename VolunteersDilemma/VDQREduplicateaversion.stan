...
model {
  ...
  Volunteer ~ binomial_logit(count,lambda*(
      V-c-theta_i.*(1.0-pow(1.0-sigmaV[GameID],GroupSize[GameID]-1.0))-V*(1.0-pow(1.0-sigmaV[GameID],GroupSize[GameID]-1.0))-L*pow(1.0-sigmaV[GameID],GroupSize[GameID]-1.0)
    ));
